...
var autoprefixerOptions = {  overrideBrowserslist: ['last 2 versions', '> 5%', 'Firefox ESR'] };
...
gulp.task('watch', function() {
    ...
    gulp.watch([inputTemplates, './templates/**/*.html'], gulp.series('nunjucks')).on('change', browserSync.reload);
...
gulp.task('default', gulp.parallel('sass', 'nunjucks', 'img', 'scripts', 'watch', 'browser-sync'));
